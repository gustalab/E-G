...
## PROPOSAL
    ...
    div(
      ...
      tags$image(src = "ring.jpg", type = "image/jpg", class = "img-rounded img-responsive"),
      class = "text-danger",
      ...
      div(
        ...
        style = "background-color:#E5E4E2;",
        class = "text-danger",
        h1(class= "text-center", strong("20.04.2023")),
    ...
    #     4, 
    #     wellPanel(
    #       radioButtons("q1", "Picture:",
    #                    c("Acting", "Fahrenheit 414"))
    #     )
    #   ),
    #   column(
    #     4, 
